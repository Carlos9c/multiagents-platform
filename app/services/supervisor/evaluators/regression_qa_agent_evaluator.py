"""
Supervisor evaluator for the regression_qa_agent.

Reads QA session records where regression_qa_agent ran and assesses the quality
of the regression comparison: whether regressions are correctly identified,
whether the resolved-count is accurate, and whether findings are well-evidenced.
"""
...
_SYSTEM_PROMPT = prompt_loader.get("regression_qa_agent_evaluator")

_AGENT_NAME = "regression_qa_agent"


def _build_user_prompt(*, project_id: int, ctx: dict) -> str:
    prompt_loader.validate_builder_inputs(
        "regression_qa_agent_evaluator",
        "main",
        {
    ...
    return (
        ...
        "findings (with category='regression'), findings_summary.\n\n"
        f"Assess comparison accuracy and regression detection precision for the {_AGENT_NAME}."
    )


class RegressionQAAgentEvaluator:
    """Evaluates the regression_qa_agent's comparison accuracy and detection quality."""
    ...
    def evaluate(
        ...
        *,
        ...
        raw = provider.generate_structured(
            ...
            schema_name="regression_qa_agent_evaluator_output",
        ...
        try:
            ...
            logger.warning("regression_qa_agent_evaluator_validation_failed exc=%s", exc)
