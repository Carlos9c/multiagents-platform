"""
Supervisor evaluator for the performance_qa_agent.

Reads QA session records where performance_qa_agent ran and assesses the
quality of threshold application and source-level performance finding analysis.
"""
...
_SYSTEM_PROMPT = prompt_loader.get("performance_qa_agent_evaluator")

_AGENT_NAME = "performance_qa_agent"


def _build_user_prompt(*, project_id: int, ctx: dict) -> str:
    prompt_loader.validate_builder_inputs(
        "performance_qa_agent_evaluator",
        "main",
        {
    ...
    return (
        ...
        "findings (with category='performance'), findings_summary.\n\n"
        f"Assess threshold-checking correctness and source-analysis depth for the {_AGENT_NAME}."
    )


class PerformanceQAAgentEvaluator:
    """Evaluates the performance_qa_agent's threshold checks and source analysis."""
    ...
    def evaluate(
        ...
        *,
        ...
        raw = provider.generate_structured(
            ...
            schema_name="performance_qa_agent_evaluator_output",
        ...
        try:
            ...
            logger.warning("performance_qa_agent_evaluator_validation_failed exc=%s", exc)
