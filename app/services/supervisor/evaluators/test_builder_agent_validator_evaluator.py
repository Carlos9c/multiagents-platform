"""
Supervisor evaluator for the test_builder_agent_validator (validator side of the pair).

Assesses calibration accuracy, finding specificity around acceptance_criteria coverage,
placeholder test detection, and partial_annotation actionability.
"""
...
TEST_BUILDER_AGENT_VALIDATOR_EVALUATOR_SYSTEM_PROMPT = prompt_loader.get(
...
def _build_user_prompt(
    *,
    ...
    return f"""
Evaluate the test_builder_agent_validator's calibration and findings quality for project {project_id}.
...
Assess calibration, finding specificity around acceptance_criteria coverage,
placeholder detection accuracy, and partial_annotation actionability.
Reference specific run_id, task_title, and acceptance_criteria items when raising issues.
""".strip()
    ...
    def evaluate(
        ...
        *,
        ...
        raw = provider.generate_structured(
            system_prompt=TEST_BUILDER_AGENT_VALIDATOR_EVALUATOR_SYSTEM_PROMPT,
            user_prompt=user_prompt,
            schema_name="test_builder_agent_validator_evaluator_output",
