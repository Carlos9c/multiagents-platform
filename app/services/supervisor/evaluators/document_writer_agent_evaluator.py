"""
Supervisor evaluator for the document_writer_agent (executor side of the pair).

Evaluates documentation generation patterns: output format appropriateness,
file placement, scope coverage, and retry improvement.
"""
...
DOCUMENT_WRITER_AGENT_EVALUATOR_SYSTEM_PROMPT = prompt_loader.get("document_writer_agent_evaluator")
...
def _build_user_prompt(
    *,
    ...
    prompt_loader.validate_builder_inputs(
        "document_writer_agent_evaluator",
        "main",
        {
    ...
    return f"""
Evaluate the document_writer_agent's documentation generation patterns for project {project_id}.
...
Assess output format appropriateness, file placement, scope coverage against
acceptance_criteria, and retry improvement.
Do NOT assess document content quality.
...
class DocumentWriterAgentEvaluator:
    """Evaluates the document_writer_agent's behavioral patterns for a project."""
    ...
    def evaluate(
        ...
        *,
        ...
        raw = provider.generate_structured(
            system_prompt=DOCUMENT_WRITER_AGENT_EVALUATOR_SYSTEM_PROMPT,
            user_prompt=user_prompt,
            schema_name="document_writer_agent_evaluator_output",
