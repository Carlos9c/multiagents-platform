"""
Supervisor evaluator for the adversarial_qa_agent.

Reads QA session records where adversarial_qa_agent ran and assesses the
attack scenario quality: realism, specificity, code-level evidence discipline,
and whether reported findings are genuinely exploitable.
"""
...
_SYSTEM_PROMPT = prompt_loader.get("adversarial_qa_agent_evaluator")

_AGENT_NAME = "adversarial_qa_agent"


def _build_user_prompt(*, project_id: int, ctx: dict) -> str:
    prompt_loader.validate_builder_inputs(
        "adversarial_qa_agent_evaluator",
        "main",
        {
    ...
    return (
        ...
        "findings (with category='adversarial'), findings_summary.\n\n"
        f"Assess attack scenario realism, specificity, and evidence discipline for the {_AGENT_NAME}."
    )


class AdversarialQAAgentEvaluator:
    """Evaluates the adversarial_qa_agent's attack quality and evidence discipline."""
    ...
    def evaluate(
        ...
        *,
        ...
        raw = provider.generate_structured(
            ...
            schema_name="adversarial_qa_agent_evaluator_output",
        ...
        try:
            ...
            logger.warning("adversarial_qa_agent_evaluator_validation_failed exc=%s", exc)
