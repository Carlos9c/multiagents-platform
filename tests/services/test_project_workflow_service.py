...
def test_workflow_adopts_patched_execution_plan_even_when_assignment_does_not_require_resequence(
    ...
    assert result.iterations[0].batch_ids_processed == ["batch_1", "batch_1_patch_1", "batch_2"]
    assert executed_task_ids == [batch_1_task.id, inserted_patch_task.id, final_batch_task.id]
