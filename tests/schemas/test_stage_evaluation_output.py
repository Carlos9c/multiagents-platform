...
def test_stage_evaluation_output_auto_fixes_contradictory_replan_signals():
    output = StageEvaluationOutput(
        ...
        remaining_plan_still_valid=True,  # contradicts replan high_level — auto-fixed
